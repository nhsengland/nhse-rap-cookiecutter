"""Command-line interface for the NHS DSA beginner data-science template."""
...
TEMPLATE_REPO = "gh:nhsengland/nhs-dsa-cookiecutter"
...
def main(template, checkout, no_input, config_file, output_dir, debug):
    """Generate a new beginner-friendly data-science project.

    TEMPLATE is the path or URL to the template. Defaults to the NHS DSA
